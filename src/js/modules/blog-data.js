...
const TAG_CATEGORIES = {
    backend: {
        name: '后端技术',
        priority: 1,
        tags: ['Java', 'Go', 'Rust', 'Spring Boot', 'MySQL', 'Redis', 'Kafka', '微服务', '分布式', '架构']
    },
    frontend: {
        name: '前端技术',
        priority: 2,
        tags: ['React', 'TypeScript', 'Vue', 'CSS', 'WebAssembly', '性能优化', 'UI/UX', 'Node.js']
    },
    ai: {
        name: '大模型技术',
        priority: 3,
        tags: ['LLM', 'GPT', '深度学习', '机器学习', 'Prompt Engineering', 'RAG', '向量数据库']
    },
    testdev: {
        name: '测试开发技术',
        priority: 4,
        tags: ['DevOps', 'CI/CD', 'Docker', 'Kubernetes', 'GitHub Actions', '自动化测试']
    },
    automation: {
        name: '自动化技术',
        priority: 5,
        tags: ['Python', '爬虫', '脚本', 'RPA', '数据处理', 'ETL', '工作流自动化']
    }
};
...
const AI_POSTS = [
    ...
    },
    {
        ...
        date: "2025-03-08",
        tags: ["Prompt Engineering", "LLM", "GPT"],
        category: "ai",
        weight: 95,
